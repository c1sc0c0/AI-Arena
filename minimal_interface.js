...
function copyToClipboard() {
    ...
    // Optionally, you can alert the copied text or notify the user in some other way
    alert("Copied the text: " + copyText.value);
}

// Function to update the text field with the current grid's JSON
function updateOutputGridJSON() {
    var outputGridJSON = JSON.stringify(CURRENT_OUTPUT_GRID.grid);
    $('#copy_input').val(outputGridJSON);
}
